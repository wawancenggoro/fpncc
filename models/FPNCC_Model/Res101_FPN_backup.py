...
class Res101_FPN(nn.Module):
    def __init__(self, ):
        ...
        # self.de_pred1 = nn.Sequential(make_layers(self.backend_feat,in_channels = self.pyramid_feature_size,dilation = False),
        #                             convDU(in_out_channels=64,kernel_size=(1,9)),
        #                             convLR(in_out_channels=64,kernel_size=(9,1)),
        #                             Conv2d(64, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred2 = nn.Sequential(make_layers(self.backend_feat,in_channels = self.pyramid_feature_size,dilation = False),
        #                             convDU(in_out_channels=64,kernel_size=(1,9)),
        #                             convLR(in_out_channels=64,kernel_size=(9,1)),
        #                             Conv2d(64, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred3 = nn.Sequential(make_layers(self.backend_feat,in_channels = self.pyramid_feature_size,dilation = False),
        #                             convDU(in_out_channels=64,kernel_size=(1,9)),
        #                             convLR(in_out_channels=64,kernel_size=(9,1)),
        #                             Conv2d(64, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred4 = nn.Sequential(make_layers(self.backend_feat,in_channels = self.pyramid_feature_size,dilation = False),
        #                             convDU(in_out_channels=64,kernel_size=(1,9)),
        #                             convLR(in_out_channels=64,kernel_size=(9,1)),
        #                             Conv2d(64, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred = nn.Sequential(make_layers(self.backend_feat,in_channels = 3,dilation = False),
        #                             convDU(in_out_channels=64,kernel_size=(1,9)),
        #                             convLR(in_out_channels=64,kernel_size=(9,1)),
        #                             Conv2d(64, 1, 1, same_padding=True, NL='relu'))
        
        self.de_pred1 = nn.Sequential(Conv2d(self.pyramid_feature_size, self.pred_feature_size, 1, same_padding=True, NL='relu'),
                                    # Conv2d(self.pred_feature_size, self.pred_feature_size, 3, same_padding=True, NL='relu'),
                                    # Conv2d(self.pred_feature_size, self.pred_feature_size, 3, same_padding=True, NL='relu'),
                                    # Conv2d(self.pred_feature_size, self.pred_feature_size, 3, same_padding=True, NL='relu'),
        ...
        self.de_pred = nn.Sequential(Conv2d(3, self.pred_feature_size, 5, same_padding=True, NL='relu'),
                                    # Conv2d(self.pred_feature_size, self.pred_feature_size, 5, same_padding=True, NL='relu'),
                                    # Conv2d(self.pred_feature_size, self.pred_feature_size, 3, same_padding=True, NL='relu'),
                                    # Conv2d(self.pred_feature_size, self.pred_feature_size, 3, same_padding=True, NL='relu'),
                                    Conv2d(self.pred_feature_size, 1, 1, same_padding=True, NL='relu'))


        # self.de_pred1 = nn.Sequential(Conv2d(256, 128, 1, same_padding=True, NL='relu'),
        #                             Conv2d(128, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred2 = nn.Sequential(Conv2d(512, 128, 1, same_padding=True, NL='relu'),
        #                             Conv2d(128, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred3 = nn.Sequential(Conv2d(1024, 128, 1, same_padding=True, NL='relu'),
        #                             Conv2d(128, 1, 1, same_padding=True, NL='relu'))

        # self.de_pred4 = nn.Sequential(Conv2d(2048, 128, 1, same_padding=True, NL='relu'),
        #                             Conv2d(128, 1, 1, same_padding=True, NL='relu'))
